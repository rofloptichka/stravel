    ...
    final ffApiRequestBody = '''
{
  ...
  "max_tokens": 900
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${OpenAIAPGroup.baseUrl}/chat/completions',
    ...
    const ffApiRequestBody = '''
{
  ...
  "user": "user-1234"
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${OpenAIAPGroup.baseUrl}/completions',
      callType: ApiCallType.POST,
      headers: {
    ...
    const ffApiRequestBody = '''
{
  ...
  "top_p": 1
    ...
    return ApiManager.instance.makeApiCall(
      callName: 'createEdit',
      apiUrl: '${OpenAIAPGroup.baseUrl}/edits',
      callType: ApiCallType.POST,
      headers: {
        'Authorization': 'Bearer $apiKey',
      },
    ...
    const ffApiRequestBody = '''
{
  ...
  "user": "user-1234"
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${OpenAIAPGroup.baseUrl}/images/generations',
      callType: ApiCallType.POST,
      headers: {
        'Authorization': 'Bearer $apiKey',
      },
...
class CreateImageEditCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${OpenAIAPGroup.baseUrl}/images/edits',
      callType: ApiCallType.POST,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
...
class CreateImageVariationCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${OpenAIAPGroup.baseUrl}/images/variations',
      callType: ApiCallType.POST,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
    ...
    const ffApiRequestBody = '''
{
  ...
  "user": "user-1234"
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${OpenAIAPGroup.baseUrl}/embeddings',
      callType: ApiCallType.POST,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
    ...
    final ffApiRequestBody = '''
{
  ...
  "speed": 1
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${OpenAIAPGroup.baseUrl}/audio/speech',
      callType: ApiCallType.POST,
      headers: {
        'Authorization':
...
class CreateTranscriptionCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${OpenAIAPGroup.baseUrl}/audio/transcriptions',
      callType: ApiCallType.POST,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
...
class CreateTranslationCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${OpenAIAPGroup.baseUrl}/audio/translations',
      callType: ApiCallType.POST,
      headers: {
        'Authorization': 'Bearer $apiKey',
      },
...
class ListFilesCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      callName: 'listFiles',
      apiUrl: '${OpenAIAPGroup.baseUrl}/files',
...
class DeleteFileCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      callName: 'deleteFile',
      apiUrl: '${OpenAIAPGroup.baseUrl}/files/$fileId',
...
class DownloadFileCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${OpenAIAPGroup.baseUrl}/files/$fileId/content',
      callType: ApiCallType.GET,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
    ...
    const ffApiRequestBody = '''
{
  ...
  "validation_file": "file-abc123"
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${OpenAIAPGroup.baseUrl}/fine_tuning/jobs',
      callType: ApiCallType.POST,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
...
class RetrieveFineTuningJobCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${OpenAIAPGroup.baseUrl}/fine_tuning/jobs/$fineTuningJobId',
      callType: ApiCallType.GET,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
...
class ListFineTuningEventsCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl:
          '${OpenAIAPGroup.baseUrl}/fine_tuning/jobs/$fineTuningJobId/events',
      callType: ApiCallType.GET,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
...
class CancelFineTuningJobCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl:
          '${OpenAIAPGroup.baseUrl}/fine_tuning/jobs/$fineTuningJobId/cancel',
      callType: ApiCallType.POST,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
    ...
    const ffApiRequestBody = '''
{
  ...
  "validation_file": "file-abc123"
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${OpenAIAPGroup.baseUrl}/fine-tunes',
      callType: ApiCallType.POST,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
...
class RetrieveFineTuneCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${OpenAIAPGroup.baseUrl}/fine-tunes/$fineTuneId',
      callType: ApiCallType.GET,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
...
class CancelFineTuneCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${OpenAIAPGroup.baseUrl}/fine-tunes/$fineTuneId/cancel',
      callType: ApiCallType.POST,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
...
class ListFineTuneEventsCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${OpenAIAPGroup.baseUrl}/fine-tunes/$fineTuneId/events',
      callType: ApiCallType.GET,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
...
class ListModelsCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      callName: 'listModels',
      apiUrl: '${OpenAIAPGroup.baseUrl}/models',
      callType: ApiCallType.GET,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
...
class RetrieveModelCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${OpenAIAPGroup.baseUrl}/models/$model',
      callType: ApiCallType.GET,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
    ...
    const ffApiRequestBody = '''
{
  ...
  "model": "text-moderation-stable"
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${OpenAIAPGroup.baseUrl}/moderations',
      callType: ApiCallType.POST,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
...
class ListAssistantsCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${OpenAIAPGroup.baseUrl}/assistants',
      callType: ApiCallType.GET,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
...
class GetAssistantCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${OpenAIAPGroup.baseUrl}/assistants/$assistantId',
      callType: ApiCallType.GET,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
    ...
    const ffApiRequestBody = '''
{
  ...
  "metadata": {}
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${OpenAIAPGroup.baseUrl}/threads',
      callType: ApiCallType.POST,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
...
class GetThreadCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      callName: 'getThread',
      apiUrl: '${OpenAIAPGroup.baseUrl}/threads/$threadId',
      callType: ApiCallType.GET,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
...
class ListMessagesCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${OpenAIAPGroup.baseUrl}/threads/$threadId/messages',
      callType: ApiCallType.GET,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
...
class GetMessageCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      callName: 'getMessage',
      apiUrl:
          '${OpenAIAPGroup.baseUrl}/threads/$threadId/messages/$messageId',
      callType: ApiCallType.GET,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
    ...
    const ffApiRequestBody = '''
{
  ...
  "metadata": {}
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${OpenAIAPGroup.baseUrl}/threads/runs',
      callType: ApiCallType.POST,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
...
class ListRunsCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      callName: 'listRuns',
      apiUrl: '${OpenAIAPGroup.baseUrl}/threads/$threadId/runs',
      callType: ApiCallType.GET,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
...
class GetRunCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      callName: 'getRun',
      apiUrl: '${OpenAIAPGroup.baseUrl}/threads/$threadId/runs/$runId',
      callType: ApiCallType.GET,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
    ...
    const ffApiRequestBody = '''
{
  "tool_outputs": [
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl:
          '${OpenAIAPGroup.baseUrl}/threads/$threadId/runs/$runId/submit_tool_outputs',
      callType: ApiCallType.POST,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
...
class CancelRunCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      callName: 'cancelRun',
      apiUrl:
          '${OpenAIAPGroup.baseUrl}/threads/$threadId/runs/$runId/cancel',
      callType: ApiCallType.POST,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
...
class ListRunStepsCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl:
          '${OpenAIAPGroup.baseUrl}/threads/$threadId/runs/$runId/steps',
      callType: ApiCallType.GET,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
...
class GetRunStepCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      callName: 'getRunStep',
      apiUrl:
          '${OpenAIAPGroup.baseUrl}/threads/$threadId/runs/$runId/steps/$stepId',
      callType: ApiCallType.GET,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
...
class ListAssistantFilesCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${OpenAIAPGroup.baseUrl}/assistants/$assistantId/files',
      callType: ApiCallType.GET,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
...
class GetAssistantFileCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl:
          '${OpenAIAPGroup.baseUrl}/assistants/$assistantId/files/$fileId',
      callType: ApiCallType.GET,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
...
class ListMessageFilesCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl:
          '${OpenAIAPGroup.baseUrl}/threads/$threadId/messages/$messageId/files',
      callType: ApiCallType.GET,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
...
class GetMessageFileCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl:
          '${OpenAIAPGroup.baseUrl}/threads/$threadId/messages/$messageId/files/$fileId',
      callType: ApiCallType.GET,
      headers: {
        'Authorization': 'Bearer $apiKeyAuth',
      },
