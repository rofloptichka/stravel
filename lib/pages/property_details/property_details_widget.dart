                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Builder(
                        builder: (context) {
                          final image = widget.propertyRef?.image
                                  .map((e) => e)
                                  .toList()
                                  .toList() ??
                              [];
                      ...
                      Padding(
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Row(
                            mainAxisSize: MainAxisSize.max,
                            children: [
                              if (widget.propertyRef?.pool ?? true)
                                Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 8.0, 0.0),
                                  child: wrapWithModel(
                              ...
                              if (widget.propertyRef?.gym ?? true)
                                Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 8.0, 0.0),
                                  child: wrapWithModel(
                              ...
                              if (widget.propertyRef?.bar ?? true)
                                Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 8.0, 0.0),
                                  child: wrapWithModel(
                              ...
                              if (widget.propertyRef?.events ?? true)
                                Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 8.0, 0.0),
                                  child: wrapWithModel(
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Text(
                                widget.propertyRef!.price.toString(),
                                style: FlutterFlowTheme.of(context)
                                    .headlineSmall
                                    .override(
                                      fontFamily: 'Urbanist',
                      ...
                      if (widget.propertyRef?.owner != currentUserReference)
                        FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed(
                              'bookNow',
