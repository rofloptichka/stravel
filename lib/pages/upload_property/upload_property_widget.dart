...
import 'upload_property_model.dart';
export 'upload_property_model.dart';

class UploadPropertyWidget extends StatefulWidget {
  const UploadPropertyWidget({super.key});

  @override
  _UploadPropertyWidgetState createState() => _UploadPropertyWidgetState();
}

class _UploadPropertyWidgetState extends State<UploadPropertyWidget>
    with TickerProviderStateMixin {
  late UploadPropertyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UploadPropertyModel());
          ...
          children: [
            ...
            Padding(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  labelText: FFLocalizations.of(context).getText(
                    'rereo5fm' /* Цена для одного человека */,
                  ),
                  labelStyle: FlutterFlowTheme.of(context).labelMedium,
                  alignLabelWithHint: false,
                  hintStyle: FlutterFlowTheme.of(context).labelMedium,
